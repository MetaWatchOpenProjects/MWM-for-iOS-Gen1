 ...
 *
 */
- (void) writeImage:(NSData*)imgData forMode:(unsigned char)mode inRect:(CGRect)rect linesPerMessage:(unsigned char)lpm shouldLoadTemplate:(BOOL)loadTemplate buzzWhenDone:(BOOL)buzz;
/*!
 *  @method loadTemplate:
