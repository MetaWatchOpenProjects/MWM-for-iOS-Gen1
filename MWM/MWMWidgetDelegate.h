...
@protocol MWMWidgetDelegate <NSObject>

// MWMWidget preview is ready to add to watch simulation screen
- (void) widgetViewCreated:(id)widget;

// MWMWidget preview should remove from watch simulation screen
- (void) widgetViewShoudRemove:(id)widget;

// MWMWidget should update the watch screen
